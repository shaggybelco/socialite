...
exports.getUserImage = (req, res) => {
  ...
  pool.query('SELECT u.name,u.id, i.userid,i.image, i.caption, i.date FROM images i, users u WHERE i.userid = $1 AND u.id = i.userid ORDER BY date ', [id], (error, results) => {
